...
public class Student {
	...
	public Student(String homeInstitution, String countryOfHomeInstitution,
			...
			String studyStartDate, String placementStartDate,
	...
	public String toString() {
		...
		String studyStartDate = this.getStudyStartDate();
		String placementStartDate = this.getPlacementStartDate();
		...
		str.append(SPLIT).append(studyStartDate != null ? studyStartDate : DEFAULT_STR);
		str.append(SPLIT).append(placementStartDate != null ? placementStartDate : DEFAULT_STR);
	...
	public static Student fromString(String stringifiedStudent) throws StudentParseException {
		...
		try {
			...
			if (studentFields.length <= NUM_ATTRIBUTES_BASIC) {
				...
				String studyStartDateStr = studyStartDate != null ? studyStartDate.toString() : null;
				String placementStartDateStr = placementStartDate != null ? placementStartDate.toString() : null;
				...
				student = new Student(homeInstitution, countryOfHomeInstitution,
						...
						studyStartDateStr, placementStartDateStr, taughtHostLang,
	...
	public static Boolean boolFromChar(String input) {
		final char YES = 'Y';
		final char NO = 'N';
	...
	public static LocalDate dateFromString(String input) throws DateTimeParseException {
