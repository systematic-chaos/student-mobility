...
public class GeneralQuery10 {
	...
	public static class StudentGenderCountMapper extends HadoopMapper<Text, DoubleWritable> {
	...
	public static class StudentGenderProportionReducer extends HadoopReducer<Text, DoubleWritable> {
	...
	// hadoop jar target/hadoop-1.0.0.jar systematicchaos.studentmobility.GeneralQuery10 ../data/Student_Mobility.csv out/hadoop10-output
	public static void main(String[] args) throws Exception {
		final int exitCode = HadoopJobLauncher.launchHadoopJob(
				GeneralQuery10.class.getName(),
				StudentGenderCountMapper.class, StudentGenderProportionReducer.class,
